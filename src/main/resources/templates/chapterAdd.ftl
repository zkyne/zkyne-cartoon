                ...
                <div class="row">
                    <div class="col-xs-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-8">
                                <input type="text" class="form-control" name="title" id="title" placeholder="章节标题">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-xs-8">
                                <label class="radio-inline">
                                    <input type="radio" value="1" name="isFree" checked="checked">免费
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" value="0" name="isFree">收费
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="form-group">
                        <div class="col-xs-3 col-xs-offset-9">
                            <button type="button" onclick="cartoon._addChapter('<#if cartoon.cartoonId??>${cartoon.cartoonId?c}</#if>');" id="btn-addChapter" class="btn btn-success">
                                <span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span>  添加章节
                            </button>&nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="modal fade" id="add_chapter_success" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="myModalLabel">
        ...
        <div class="modal-content" style="margin-top: 200px">
            <div class="modal-body">
                <div class="row text-center">
                    ...
                    <div class="col-xs-12" style="margin-top: 20px">
                        <span style="font-size: 22px;font-weight: bold">恭喜您，作品章节提交成功！</span>
                    </div>
                </div>
